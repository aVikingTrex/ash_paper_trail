...
| [`apply_can_read_policy?`](#paper_trail-apply_can_read_policy?){: #paper_trail-apply_can_read_policy? } | `boolean` | `false` | Whether to restrict version reads using the source resource's read policies. |
